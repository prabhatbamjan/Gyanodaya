...
import { ArrowLeft, Pencil, Trash, Tag, Package, DollarSign, Calendar, User, Truck } from 'lucide-react';
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      <span className={`bg-${product.inStock ? 'green' : 'red'}-100 text-${product.inStock ? 'green' : 'red'}-800 text-xs font-medium px-2.5 py-0.5 rounded`}>
                  ...
                  <div className="mt-4 md:mt-0">
                    ...
                    {product.compareAtPrice && (
                      <div className="text-lg line-through text-gray-400">${product.compareAtPrice.toFixed(2)}</div>
                    )}
                  </div>
                </div>
            ...
            {activeTab === 'details' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm font-medium text-gray-800">{product.brand || 'N/A'}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Product Attributes</h4>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 gap-4">
                        <div>
                          <label className="block text-xs text-gray-500">SKU</label>
                          <div className="text-sm font-medium text-gray-800">{product.sku || 'N/A'}</div>
                        </div>
                        <div>
            ...
            {activeTab === 'inventory' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className={`bg-${product.inStock ? 'green' : 'red'}-50 p-4 rounded-lg`}>
                    <h4 className={`text-sm font-medium text-${product.inStock ? 'green' : 'red'}-700 mb-1`}>Status</h4>
                    <p className={`text-2xl font-bold text-${product.inStock ? 'green' : 'red'}-800`}>
                      {product.inStock ? 'In Stock' : 'Out of Stock'}
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-blue-800">{product.quantity || 0}</p>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h4 className="text-sm font-medium text-purple-700 mb-1">Warehouse</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Stock Management</h4>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 gap-4">
                        <div>
                        ...
                        <div>
                          <label className="block text-xs text-gray-500">Restock Status</label>
                          <div className="text-sm font-medium text-gray-800">
                            {product.restockStatus || 'Not applicable'}
                          </div>
                        </div>
                        <div>
                          <label className="block text-xs text-gray-500">Last Restocked</label>
                          <div className="text-sm font-medium text-gray-800">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 gap-4">
                        ...
                        <div>
                          <label className="block text-xs text-gray-500">Lead Time</label>
                          <div className="text-sm font-medium text-gray-800">
                            {product.leadTime ? `${product.leadTime} days` : 'N/A'}
                          </div>
                        </div>
                        <div>
                          <label className="block text-xs text-gray-500">Minimum Order Quantity</label>
                          <div className="text-sm font-medium text-gray-800">
            ...
            {activeTab === 'pricing' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="text-sm font-medium text-blue-700 mb-1">Cost</h4>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-purple-800">
                      ${product.cost ? (product.price - product.cost).toFixed(2) : product.price.toFixed(2)}
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Pricing Details</h4>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 gap-4">
                        <div>
                        ...
                        <div>
                          <label className="block text-xs text-gray-500">Compare At Price</label>
                          <div className="text-sm font-medium text-gray-800">
                        ...
                        {product.compareAtPrice && (
                          <div>
                            ...
                            <div className="text-sm font-medium text-gray-800">
                              {(((product.compareAtPrice - product.price) / product.compareAtPrice) * 100).toFixed(0)}% off
                            </div>
                          </div>
                        )}
                      </div>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Cost Information</h4>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 gap-4">
                        <div>
                          <label className="block text-xs text-gray-500">Cost Per Unit</label>
                          <div className="text-sm font-medium text-gray-800">
                            ${product.cost ? product.cost.toFixed(2) : '0.00'}
                          </div>
                        </div>
                        <div>
                          <label className="block text-xs text-gray-500">Profit Margin</label>
                          <div className="text-sm font-medium text-gray-800">
                            {product.cost 
                        ...
                        <div>
                          ...
                          <div className="text-sm font-medium text-gray-800">
                            {product.taxRate ? `${product.taxRate}%` : 'Standard tax rate'}
                          </div>
                        </div>
                      </div>
                    </div>
