...
const EditSalary = () => {
  ...
  const fetchSalaryData = async () => {
    try {
      const response = await authAxios.get(`/api/salaries/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await authAxios.put(`/api/salaries/${id}`, formData);
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Edit Salary Record</h1>
